// v39 - drill-down + gestão + físico-financeiro + UI + composições + exportação + serviços + SINAPI + cronograma
(function(){
  ...
  load('app-management-v30.js?v=39','__managementV30','Falha ao carregar painel de gestão v30');
  load('app-physical-financial-v31.js?v=39','__physicalFinancialV31','Falha ao carregar cronograma físico-financeiro v31');
  load('app-ui-v32.js?v=39','__uiV32','Falha ao carregar melhorias visuais v32');
  load('app-compositions-v33.js?v=39','__compositionsV33','Falha ao carregar composições');
  load('app-budget-export-v34.js?v=39','__budgetExportV34','Falha ao carregar exportação');
  load('app-service-manager-v35.js?v=39','__serviceManagerV35','Falha ao carregar gerenciador de serviços');
  load('app-detail-composition-v37.js?v=39','__detailCompositionV37','Falha ao carregar composição na lista');
  load('app-sinapi-v38.js?v=39','__sinapiV38','Falha ao carregar busca SINAPI');
  load('app-schedule-service-v39.js?v=39','__scheduleServiceV39','Falha ao carregar integração cronograma v39');
})();