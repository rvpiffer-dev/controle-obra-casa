...
(function(){
  ...
  load('app-management-v30.js?v=39','__managementV30','Falha ao carregar painel de gestão');
  load('app-physical-financial-v31.js?v=39','__physicalFinancialV31','Falha ao carregar físico-financeiro');
  load('app-ui-v32.js?v=39','__uiV32','Falha ao carregar UI');
  ...
  load('app-sinapi-v38.js?v=39','__sinapiV38','Falha ao carregar busca SINAPI',()=>load('app-schedule-service-v39.js?v=39','__scheduleServiceV39','Falha ao carregar integração cronograma v39'));
})();