// v35 - drill-down + gestão + físico-financeiro + UI + composições + exportação + serviços
(function(){
  ...
  load('app-management-v30.js?v=35','__managementV30','Falha ao carregar painel de gestão v30');
  load('app-physical-financial-v31.js?v=35','__physicalFinancialV31','Falha ao carregar cronograma físico-financeiro v31');
  load('app-ui-v32.js?v=35','__uiV32','Falha ao carregar melhorias visuais v32');
  load('app-compositions-v33.js?v=35','__compositionsV33','Falha ao carregar composições v35');
  load('app-budget-export-v34.js?v=35','__budgetExportV34','Falha ao carregar exportação v34');
  load('app-service-manager-v35.js?v=35','__serviceManagerV35','Falha ao carregar gerenciador de serviços v35');
})();